...
fn main() {
    let mat1 = arr2(&[[4., -17.], [15., -4.], [30., -7.], [100., 50.], [200., 70.]]);
    ...
    let mat_a: Array2<f64> = arr2(&[[a_11, a_12], [a_12, a_22]]);
    println!("{}", mat_a);
    ...
    let precision_y = v_x
        .map(|&x| f(coefficient_x[0], coefficient_x[1], x))
        .into_raw_vec();
    ...
    let s1: Plot = Plot::new(data1).point_style(PointStyle::new().colour("#35C788"));
